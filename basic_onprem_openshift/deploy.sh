#!/usr/bin/env bash
#
# deploy.sh — basic_onprem_openshift: NetworkPolicy + Workloads + Service + PersistentVolume + VM
#
#   ./deploy.sh              build and deploy the default target (openshift)
#
